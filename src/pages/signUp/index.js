...
export default function SignUp() {
    ...
    const onSubmit = (data) => {
        if (data.forgot_password === data.password) {
            signup(data.email, data.password, dispatch)
        } else {
            dispatch({ type: 'notification', payload: { status: 'error', active: true, text: 'пароли не совпадают' } })
        }
    }
            ...
            <Container component="main" maxWidth="xs">
                ...
                >
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Input variant="outlined" label="Forgot-Password" {...register('forgot_password')} id="password" required type="password" />
                        <FormControlLabel
